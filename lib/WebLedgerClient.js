...
class WebLedgerClient {
   ...
   * @param {boolean} [strictSSL=true] - validate the host's SSL certificate.
   * @param [logger] - the logger to use.
   * @param {Agent} [httpsAgent] - a custom `https.Agent` instance.
   */
  constructor({httpsAgent, hostname, logger, strictSSL = true}) {
